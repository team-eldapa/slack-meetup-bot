...
const getDetails = parse => {
  const html = parse.querySelectorAll('.event_summary');

  console.log(html[0].childNodes[1].childNodes[0]);
  ...
  // const events = html.querySelectorAll('.p-name')
  ...
  // console.log(events.length, 'urls');

  // organizeData(events);
};

// const organizeData = (events) => {
//   let event = {};
